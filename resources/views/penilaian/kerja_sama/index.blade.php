...
@section('title', 'Data Penilaian Kerja Sama')
        ...
        <div class="col-12">
            <div class="card shadow-sm mt-3">
                <div class="card-header bg-light text-white">
                    <h4 class="card-title mb-0"><strong>Data Penilaian Kerja Sama</strong></h4>
                        <a href="{{ route('penilaian.create', 'kerja_sama') }}" class="btn btn-primary btn-sm float-right" style="color: white !important;">
        ...
        $(document).ready(function () {
            $('#penilaianTable').DataTable({
                ...
                language: {
                    ...
                    zeroRecords: "Belum ada data penilaian kerja sama",
