...
@section('title', 'Data Penilaian Objektif')
        ...
        <div class="col-12">
            <div class="card shadow-sm mt-3">
                <div class="card-header bg-light text-white">
                    <h4 class="card-title mb-0"><strong>Data Penilaian Objektif</strong></h4>
                    @if(auth('pegawai')->user()->bawahan->count() > 0)
                        <a href="{{ route('penilaian.create', 'objektif') }}" class="btn btn-primary btn-sm float-right" style="color: white !important;">
        ...
        $(document).ready(function () {
            $('#penilaianTable').DataTable({
                ...
                language: {
                    ...
                    zeroRecords: "Belum ada data penilaian objektif",
