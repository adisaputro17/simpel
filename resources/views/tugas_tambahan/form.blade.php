...
<div class="form-group">
    <div class="row">
        <div class="col-md-6">
            ...
            <input type="time" name="jam_mulai" class="form-control" value="{{ old('jam_mulai', isset($item->jam_mulai) ? substr($item->jam_mulai, 0, 5) : '') }}" required>
        </div>
        <div class="col-md-6">
            <label for="jam_selesai">Jam Selesai</label>
            <input type="time" name="jam_selesai" class="form-control" value="{{ old('jam_selesai', isset($item->jam_selesai) ? substr($item->jam_selesai, 0, 5) : '') }}" required>
        </div>
    </div>
</div>
